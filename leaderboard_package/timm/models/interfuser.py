...
@register_model
def interfuser_baseline_commandgru(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
        rgb_backbone_name="r50",
        lidar_backbone_name="r18",
        waypoints_pred_head="gru-command",
        use_different_backbone=True,
    )
    return model
...
@register_model
def interfuser_baseline_wolidar_center(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
@register_model
def interfuser_baseline_wolidar_center_leftright(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
@register_model
def interfuser_baseline_woleftright(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
@register_model
def interfuser_baseline_woleftright_center(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
@register_model
def interfuser_baseline_linear(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
@register_model
def interfuser_baseline_heatmap(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
@register_model
def interfuser_baseline_wo_view_embed(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
# end2end
@register_model
def interfuser_baseline_end2end(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
...
@register_model
def interfuser_baseline_direct_concat(**kwargs):
    model = Interfuser(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
