...
class InterfuserAgent(autonomous_agent.AutonomousAgent):
    ...
    def get_sensor_data(self):
        sensor_data=super().get_sensor_data()
        return sensor_data
    ...
    def run_step(self, input_data, timestamp):
        ...
        # 比较一下input_data和sensor_data的区别
        # sensor_data=self.get_sensor_data()
        # print("-----------")
        # print("input_data和sensor_data是否相同:",sensor_data==input_data)
        # print("type(sensor_data):",type(sensor_data))
        # print("type(input_data):",type(input_data))
        # print("子类：sensor_data:",sensor_data)
