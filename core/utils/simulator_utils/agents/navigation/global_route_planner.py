...
import carla
from core.utils.simulator_utils.agents.navigation.local_planner import RoadOption
from core.utils.simulator_utils.agents.tools.misc import vector
...
class GlobalRoutePlanner(object):
    ...
    def _turn_decision(self, index, route, threshold=math.radians(35)):
        ...
        if index > 0:
            if self._previous_decision != RoadOption.VOID and self._intersection_end_node > 0 and self._intersection_end_node != previous_node and next_edge[
